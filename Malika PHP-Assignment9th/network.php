...
<html>
	...
	<body>
		...
		<div class="row">
			<div class="container">
				<div class="col-md-12">
					<h1 class="text-center" style="color:gray; font-weight:bold;padding:20px; font-size:3em;margin-top:10%">Network Books</h1>
					<hr />
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row" style="margin-top: 2%;">
				...
				mysqli_set_charset($connect,"utf8");	
							$queryone="SELECT * FROM list_books WHERE book_name='$search' AND department='network'";
				...
				mysqli_set_charset($connect,"utf8");	
							$queryone="SELECT * FROM list_books WHERE department='network'";
							//echo $queryone;
							$resultone=mysqli_query($connect,$queryone);
							$count=0;
