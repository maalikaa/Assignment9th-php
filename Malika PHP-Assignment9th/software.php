...
<html>
	...
	<body>
		...
		<div class="row">
			<div class="container">
				<div class="col-md-12">
					<h1 class="text-center">Software Books</h1>
					<hr />
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row" style="margin-top: 2%;">
				...
				mysqli_set_charset($connect,"utf8");	
							$queryone="SELECT * FROM list_books where book_name='$search' AND department='software'";
							//echo $queryone;
				...
				mysqli_set_charset($connect,"utf8");	
							$queryone="SELECT * FROM list_books WHERE department='software'";
							//echo $queryone;
							$resultone=mysqli_query($connect,$queryone);
							$count=0;
